...
# ==========================================
# 2. 사진 100% 반영: Deep Dark Glass UI CSS
# ==========================================
st.markdown("""<style>
    ...
    /* [사이드바] 사진처럼 완전히 투명하고 깔끔하게 */
    [data-testid="stSidebar"] {
        background: transparent !important; /* 배경색 날림 */
    ...
    [data-testid="stSidebar"] div.row-widget.stRadio > div[role="radiogroup"] { gap: 4px; padding: 10px 15px; }
    [data-testid="stSidebar"] div.row-widget.stRadio > div[role="radiogroup"] > label {
        background: transparent !important;
        border: none !important;
        border-radius: 8px !important; /* 약간의 라운딩만 */
        padding: 12px 16px !important;
        cursor: pointer; width: 100%; transition: all 0.2s ease !important;
    }
    [data-testid="stSidebar"] div.row-widget.stRadio > div[role="radiogroup"] > label p {
        font-size: 0.95em !important; font-weight: 500 !important; color: var(--text-muted) !important; margin: 0 !important;
    }
    [data-testid="stSidebar"] div.row-widget.stRadio > div[role="radiogroup"] > label:hover {
        background: rgba(255, 255, 255, 0.05) !important;
    }
    [data-testid="stSidebar"] div.row-widget.stRadio > div[role="radiogroup"] > label:hover p { color: var(--text-main) !important; }
    
    /* 선택된 메뉴 (사진처럼 왼쪽에 보라색 바 생성) */
    [data-testid="stSidebar"] div.row-widget.stRadio > div[role="radiogroup"] > label[data-baseweb="radio"]:has(input:checked) {
        background: rgba(139, 92, 246, 0.1) !important;
        border-left: 3px solid var(--accent-purple) !important; /* 핵심 포인트 */
    ...
    /* [메인 패널 (Glass Card)] 사진의 모던한 반투명 다크 패널 */
    .glass-card {
        background: var(--bg-panel) !important;
        backdrop-filter: blur(20px) !important;
        -webkit-backdrop-filter: blur(20px) !important;
        border: 1px solid var(--border-glass) !important;
        border-radius: 16px !important; /* 너무 둥글지 않게 모던하게 */
...
<div style="padding: 20px 15px;">
    <div style="font-size: 1.5em; font-weight: 800; color: #F8FAFC; letter-spacing: -0.5px;">AMLS <span style="color:#8B5CF6;">V4.5</span></div>
    <div style="font-size: 0.8em; font-weight: 500; color: #94A3B8; margin-bottom: 15px;">QUANTITATIVE ENGINE</div>
...
<div style="margin-top: 40px; padding: 15px; border-top: 1px solid rgba(255,255,255,0.05);">
