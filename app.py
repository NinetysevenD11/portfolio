...
rt_label = f"LIVE DATA ({len(rt_injected)})" if rt_ok else "DELAYED DATA"
...
if curr_regime == live_regime:
    ...
    regime_committee_msg = f"R{live_regime} 신호 감지 — 5일 확인 대기 중"

# ==========================================
# 2. 전면 개편된 2026 Spatial UI CSS
# ==========================================
# 모든 타협을 버리고 완벽한 공간 컴퓨팅(VisionOS) 스타일로 재구성
st.markdown("""<style>
    ...
    div.row-widget.stRadio > div > label {
        ...
        border-radius: 50px !important; /* 완벽한 알약 형태 */
    ...
    .glass-card {
        ...
        box-shadow: 
            ...
            inset 0 2px 0 rgba(255, 255, 255, 1) !important; /* 상단 강한 빛 반사 */
    ...
    /* Streamlit 요소 투명화 */
    [data-testid="stMetric"] { background: transparent !important; border: none !important; box-shadow: none !important; }
    div[data-testid="stMetricValue"]>div { color: #0F172A !important; font-weight: 800; font-family: 'Outfit'; font-size: 2.2em; }
...
.ai-report-box strong {{ color: #0F172A; font-weight: 800; background-color: rgba(255,255,255,0.7); padding: 2px 8px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.02); }}
</style>
