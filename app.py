...
@@ -94,63 +95,76 @@ def save_accounts_data(data_dict):
...
@@ -159,10 +173,12 @@ def save_accounts_data(data_dict):
...
@@ -182,9 +198,58 @@ def apply_custom_css():
...
@@ -201,22 +266,7 @@ def apply_custom_css():
...
@@ -228,9 +278,11 @@ def apply_custom_css():
...
@@ -242,10 +294,12 @@ def apply_custom_css():
...
@@ -258,27 +312,9 @@ def apply_custom_css():
...
@@ -1064,7 +1095,7 @@ def page_strategy_specification():
