...
<div style="background: rgba(255,255,255,0.6); border: 1px solid rgba(255,255,255,0.9); border-radius: 20px; padding: 22px; margin-bottom: 10px; box-shadow: 0 8px 25px rgba(0,0,0,0.03);">
    ...
    <div style="font-family: 'Outfit'; font-size: 0.85em; font-weight: 700; color: #0F172A; margin-bottom: 15px; letter-spacing: 0.5px;">FINANCE ENGINE</div>
    <div style="font-size: 0.75em; color: #4F46E5; font-weight: 800; padding: 6px 12px; background: rgba(79,70,229,0.1); border-radius: 50px; display: inline-block; border: 1px solid rgba(79,70,229,0.2);">
        {rt_label}
    </div>
