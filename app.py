...
<div style="font-size:0.9em; margin-top:10px; color:#A0AEC0;">{rt_label}</div>
</div>
...
st.sidebar.markdown(f"<p style='font-size:0.8em; text-transform:uppercase; color:#A0AEC0; margin-top:20px;'>Powered by Apex</p>", unsafe_allow_html=True)
st.sidebar.markdown(f"""<div class="apex-sidebar-card">
<div style="text-align:left; color:#A0AEC0; font-size:0.85em;">
